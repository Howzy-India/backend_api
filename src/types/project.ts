...
export interface ProjectRow {
  ...
  lead_registration_type: string | null;
  lead_registration_email: string | null;
  lead_registration_app_link: string | null;
  lead_registration_app_id: string | null;
  lead_registration_app_password: string | null;
...
export interface ProjectResponse {
  ...
  projectManager: { name: string | null; contact: string | null; email: string | null };
  spoc: { name: string | null; contact: string | null; email: string | null };
  leadRegistrationType: string | null;
  leadRegistrationEmail: string | null;
  leadRegistrationAppLink: string | null;
  leadRegistrationAppId: string | null;
  leadRegistrationAppPassword: string | null;
