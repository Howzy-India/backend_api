...
export const mapProjectRow = (
  ...
  projectManager: {
    ...
    email: row.project_manager_email ?? null,
  },
  spoc: {
    name: row.spoc_name,
    contact: row.spoc_contact,
    email: row.spoc_email ?? null,
  },
  leadRegistrationType: row.lead_registration_type ?? null,
  leadRegistrationEmail: row.lead_registration_email ?? null,
  leadRegistrationAppLink: row.lead_registration_app_link ?? null,
  leadRegistrationAppId: row.lead_registration_app_id ?? null,
  leadRegistrationAppPassword: row.lead_registration_app_password ?? null,
  commissionType: row.commission_type ?? null,
  commissionValue: row.commission_value ?? null,
  usp: row.usp,
  teaser: row.teaser,
  details: row.details,
  status: row.status,
  ...
  submittedByMobile: row.submitted_by_mobile ?? null,
...
export const mapEnquiryDoc = (
  ...
  return {
    ...
    source: data.source ?? "",
    best_time_to_call: data.best_time_to_call ?? data.bestTimeToCall ?? "",
    bestTimeToCall: data.best_time_to_call ?? data.bestTimeToCall ?? "",
